...
public:
    ...
    Student(int course, int group, int NumberOfRecordBook, char* name);
...
public:
    ...
    {}
    FirstSessionStudent(int course, int group, int NumberOfRecordBook, char* name) : Student(course, group, NumberOfRecordBook, name)
    {}
    void ReadScores1();
    void SetScores1();
};
...
public:
    ...
    {}
    SecondSessionStudent(int course, int group, int NumberOfRecordBook, char* name) : FirstSessionStudent(course, group, NumberOfRecordBook, name)
    {}
    void ReadScores2();
    void SetScores2();
};
